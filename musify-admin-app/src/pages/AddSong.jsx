...
import {Check, Music, Song} from 'lucide-react';
        ...
        <DashboardLayout activeMenu="Add Song">
            {loading?(
                ...
                <form action="" onSubmit={onSubmitHandler} className="flex flex-col items-start gap-8 text-gray-600 mt-5">
                    ...
                    <div className="flex flex-col gap-2.5">
                        <p>Album</p>
                        <select defaultValue={album} onChange={(e)=>setAlbum(e.target.value)}
                        name="" id="" className="bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[150px]">
